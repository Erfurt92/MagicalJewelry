...
public class MagicalJewelryConfigBuilder
{
	...
	public static ForgeConfigSpec.BooleanValue JEWEL_GOLD_NEUTRAL_PIGLINS;
	public static String GOLD_NEUTRAL_PIGLINS = "goldNeutralPiglins";
	...
	static class CommonConfig
	{
		CommonConfig(ForgeConfigSpec.Builder config_builder)
		{
			...
			JEWEL_GOLD_NEUTRAL_PIGLINS = config_builder.comment("Should gold versions of jewels make piglins neutral").translation(translatable(GOLD_NEUTRAL_PIGLINS)).define(GOLD_NEUTRAL_PIGLINS, true);
			config_builder.pop();
			...
			JEWEL_LEGENDARY_UPGRADE_ONLY = config_builder.comment("Should Legendary rarity be upgrade only. If upgrading is disabled, you can't get Legendary rarity").translation(translatable(LEGENDARY_UPGRADE_ONLY)).define(LEGENDARY_UPGRADE_ONLY, false);
			JEWEL_UPGRADE_DISABLE = config_builder.comment("Should Jewels be able to be upgraded").translation(translatable(UPGRADE_DISABLE)).define(UPGRADE_DISABLE, false);
			config_builder.pop();
