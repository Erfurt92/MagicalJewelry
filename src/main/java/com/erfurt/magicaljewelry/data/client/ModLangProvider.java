...
public class ModLangProvider extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
        ...
        add("item.magicaljewelry.tooltip.creative", "This item have no effects or attributes attached to it, and therefore does nothing!");
        ...
        add("curios.modifiers.bracelet", "When worn as bracelet:");
    }
